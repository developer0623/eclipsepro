...
@Component({
  selector: 'app-downtime-explorer',
  templateUrl: './downtime-explorer.component.html',
  styleUrls: ['./downtime-explorer.component.scss']
})
export class DowntimeExplorerComponent implements OnInit, OnDestroy {
  cfData;
  chartList = [
    {dimension: 'byReasonDimension', group: 'byReasonGroup', title: 'Reason'},
